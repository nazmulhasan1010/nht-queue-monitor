...
@section('content')
    ...
    <div class="qp-detail-grid">
        ...
        <div class="qp-card">
            ...
            <div class="qp-meta-row">
                <span>Enabled</span><span>{{ data_get($broadcasting, 'enabled') ? 'Yes' : 'No' }}</span></div>
    ...
    <div class="qp-detail-grid" style="margin-top:16px;">
        <div class="qp-card">
            <h2>Tenant Mode</h2>
            <div class="qp-meta-row"><span>Enabled</span><span>{{ data_get($tenant, 'enabled') ? 'Yes' : 'No' }}</span>
            </div>
            <div class="qp-meta-row">
                <span>Resolver</span><span>{{ data_get($tenant, 'resolver') ? 'Configured' : 'Not configured' }}</span>
            </div>
        </div>
